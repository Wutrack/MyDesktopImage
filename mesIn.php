    ...
    <div class="mainDiv">
        <div class="title edit">
            ...
            <div class="messWrap">
                ...
                <div class="messBox">
                <?php
                    $queryMesIn = "SELECT * FROM messages WHERE receiver = '$login' ORDER BY date DESC";
                    ...
                    $queryMesIn = "SELECT * FROM messages WHERE receiver = '$login' ORDER BY date DESC LIMIT $start, $num";
                    $resultMesIn = mysqli_query($db, $queryMesIn);
                ...
                for($i=0; $i<$num; $i++){
                        if(isset($mesIn[$i]['id'])){
                            ...
                            echo '<a href="mesView.php?id='.$mesIn[$i]['id'].'&dir=in"><div class="mes" style="'.$style.'">'.
